...
## 기본 필요 툴 설치
```shell
yum install -y setuptool system-config-firewall-tui ntsysv net-tools lynx wget bind-utils
```
...
# PHP 7 + Module 설치
yum install -y php php-devel php-fpm php-json php-mbstring php-opcache php-pdo php-pecl-geoip php-pecl-imagick php-tidy php-xml php-gd php-mysql php-pecl-zip php-ioncube-loader
...
# Brotli 
yum install brotli brotli-devel
